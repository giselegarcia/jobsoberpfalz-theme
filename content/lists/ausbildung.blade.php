...
<div class="row">
    <div id="header_static" style="background-color: #9699AA; background-image: url('{{ asset('uploads/lists/' . $list->image) }}'); background-position: center; background-size: cover;">
        ...
        <div id="city_headline">
            <h1>Die besten <strong>Ausbildungsstellen</strong> auf jobs-oberpfalz.de</h1>
            <h2>Jetzt Ausbildungsplatz finden und direkt online bewerben.</h2>
        </div>
        <div class="d-none d-md-block">
            <br>
        </div>
...
<section id="latest_jobs" class="mt-4">
    <div class="row">
        <div class="col-lg-12 mb-4">
            <h2>Aktuelle Ausbildungsangebote</h2>
        </div>
        <div id="list-filter-menue" class="d-none d-lg-block col-12 position-relative col-md-3 rounded-end" style="background-color: #f49c35; padding: 25px;">
            <div class="row">
                <div class="col-12">
                    ...
                    @endif
                    @php($countContentsInFilter = getNachByFilter(getNachByFilterList(null, $list), [$listItem->slug])->exists())
...
<div class="container">
    <section class="mt-2">
        <div class="row">
            <div class="col-xs-12">
                <h2 class="mt-2">Ablauf einer <strong>{{ $list->name }}</strong></h2>
                <br>
                @if (isset($list))
                {{ $list->description }}
                @endif
