                ...
                <div class="card mt-2 mb-1" style="background-color: #f8f8f8;">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-2 col-md-3 col-lg-2 text-sm-center">
                                <a href="{{ route('content', [$nach->user->slug]) }}" onclick="gtag('event', 'See Employer', {'event_category' : 'List: {{ $listModel->name }}', 'event_label' : '{{ $nach->user->name }}'});">
                                ...
                                <a href="{{ route('content', [$nach->user->slug]) }}" style="font-size: 13px; m" class="text-muted d-none d-lg-block " onclick="gtag('event', 'See Employer', {'event_category' : 'List: {{ $listModel->name }}', 'event_label' : '{{ $nach->user->name }}'});">
                                    {{ $nach->user->name }}
                                </a>
                            </div>
                            <div class=" col-10 d-lg-none pt-sm-3">
                                <a href="{{ route('content', [$nach->user->slug]) }}" style="font-size: 13px; m" class="text-muted" onclick="gtag('event', 'See Employer', {'event_category' : 'List: {{ $listModel->name }}', 'event_label' : '{{ $nach->user->name }}'});">
                                    {{ $nach->user->name }}
                                </a>
