...
<div class="row">
    ...
    <div id="header_static"
        style="background-color: #9699AA; background-image: url('https://www.jobs-oberpfalz.de/images/manual/default-arbeitgeber-cover.jpg'); background-position: center; background-size: cover;">
        @else
        <div id="header_static"
            style="background-color: #9699AA; background-image: url('{{ asset('uploads/cover/' . $author->cover_image) }}'); background-position: center; background-size: cover;">
            @endif
            ...
            <div id="author_logo">
                <img src="{{ $author->gravatar() }}?s=120&d=identicon&r=PG" width="120" class="rounded img-fluid border"
                    title="{{ $author->name }}" alt="Logo {{ $author->name }}">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <p class="intro">{{ $author->description }}</p>
            <div class="row">
                <div class="col-md-7 col-sm-12">
                    @if (isset($author->social_networks['site']))
                    <a href="{{ $author->social_networks['site'] }}" target="_blank" style="color: #f49c35"><i
                            class="fal fa-globe"></i> {{ $author->social_networks['site'] }}</a>
                    @endif
                    <br>
                    <br>
                </div>
    ...
    <div class="col-12">
        <div class="text-center">
            ...
            <lottie-player src="https://assets8.lottiefiles.com/packages/lf20_zckmnrhp.json"
                class="img-fluid d-block mx-auto" background="transparent" speed="1"
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-3 col-lg-1">
                                <img src="{{ $nach->user->gravatar() }}" title="{{ $nach->user->name }}" height="70px"
                            ...
                            <div class="col-7 col-lg-2 text-end ">
                                <h6 class="card-subtitle mb-2 text-muted d-none d-lg-block "
                                    style="margin-right: 20px;"> {{ $nach->updated_at->diffForHumans() }}</h6>
                                <a class="btn btn-ci btn-sm" href="{{ route_content($nach) }}"
                                    onclick="gtag('event', 'See Job', {'event_category' : 'Employer: {{ $author->name }}', 'event_label' : '{{$nach->title}}'});">
                                    Job ansehen
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
    ...
    <div class="row">
        <div class="col-md-8 offset-md-2">
            ...
            <div class="ratio ratio-16x9 mb-5">
                <iframe src="https://www.youtube.com/embed/{{$author->additional_fields['youtube']}}"
