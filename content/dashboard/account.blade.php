...
<style>
    ...
    .btn-clean{
        background-color: transparent; border: none; padding: 0px; color: #6c23d7; text-decoration: underline;
    }
</style>
<div class="row">
    <div class="col-12">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12 col-md-8 offset-md-2 mt-5">
                        <form action="{{route('dashboard.users.account')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row mt-5 mb-3">
                                <div class="col text-end">
                                    <button type="submit" class="btn btn-ci btn-sm float-left" >
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12 col-md-10 offset-md-1">
                        <!-- Hier können Sie Ihren Account <a href="" class="link-danger"> vorübergehend deaktivieren</a>. <i class="fal fa-snooze"></i> -->
                        <div class="alert alert-danger mt-5">
                            <form method="post" action="{{route('users.account.destroy')}}">
                                @method('delete')
                                @csrf
                                Benutzerkonto und Daten endgültig löschen: <button class="btn-clean text-decoration-none alert-link" style="display: inline;"><i class="fal fa-trash"></i> Account löschen</button>.
                            </form>
                        </div>
                    </div>
                </div>
