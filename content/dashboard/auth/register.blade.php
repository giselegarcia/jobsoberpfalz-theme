...
<div class="row justify-content-center">
    <div class="col-12 col-md-8 ">
        ...
        <div class="card" style="background-color: #fdf7f37d">
            ...
            @endif
            <div class="card-body">
                <form method="POST" action="{{ route('dashboard.store') }}" id="demo-form">
                    @csrf
                    <br>
                    <fieldset>
                    ...
                    <div class="col col-md-10 offset-md-1">
                        ...
                        <div class="form-group row mb-4 mt-4">
                            @if(App::environment('production'))
                                <input type="submit" id="btn-demo-form" style="display: none;">
                                <button type="button" class="btn btn-ci g-recaptcha d-block" data-sitekey="6LcLebgcAAAAAInzMP8t4Nsft5DJZf3vqY3Nb3f2" data-callback="onSubmit" data-action="submit">
                                    Firmenprofil anlegen <i class="fal fa-envelope"></i>
                                </button>
                            @else
