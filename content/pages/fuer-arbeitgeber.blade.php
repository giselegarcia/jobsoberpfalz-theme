...
@section('content')
    <div class="row">
        <div id="header_static" style="background-color: #9699AA; background-image: url('https://ik.imagekit.io/areya/julian-hochgesang-Ju9J4ngPyKU-unsplash__fqrac0Up.jpg?updatedAt=1633551598716'); background-position: center; background-size: cover;">
            <div id="city_headline" class="p-1" style="background-color: rgba(255, 255, 255, 0.55);">
                <br>
            ...
            <div class="col-12 col-lg-6 mb-5">
                <div class="card h-100 shadow-lg">
                    ...
                    <div class="card-footer">
                        <a href="{{ url('/dashboard/register') }}" class="btn btn-ci btn-lg d-block">Arbeitgeberkonto erstellen <i class="fal fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-12 col-lg-6 mb-5">
                <div class="card h-100 shadow-lg">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item price-feature">
                            <svg style="fill: green; width: 14px; margin-right: 15px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!-- Font Awesome Pro 5.15.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) --><path d="M504 256c0 136.967-111.033 248-248 248S8 392.967 8 256 119.033 8 256 8s248 111.033 248 248zM227.314 387.314l184-184c6.248-6.248 6.248-16.379 0-22.627l-22.627-22.627c-6.248-6.249-16.379-6.249-22.628 0L216 308.118l-70.059-70.059c-6.248-6.248-16.379-6.248-22.628 0l-22.627 22.627c-6.248 6.248-6.248 16.379 0 22.627l104 104c6.249 6.249 16.379 6.249 22.628.001z"/></svg>
                            Keine Kosten für Anzeigenklicks
                        </li>
                        <li class="list-group-item price-feature">
                            <svg style="fill: green; width: 14px; margin-right: 15px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!-- Font Awesome Pro 5.15.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) --><path d="M504 256c0 136.967-111.033 248-248 248S8 392.967 8 256 119.033 8 256 8s248 111.033 248 248zM227.314 387.314l184-184c6.248-6.248 6.248-16.379 0-22.627l-22.627-22.627c-6.248-6.249-16.379-6.249-22.628 0L216 308.118l-70.059-70.059c-6.248-6.248-16.379-6.248-22.628 0l-22.627 22.627c-6.248 6.248-6.248 16.379 0 22.627l104 104c6.249 6.249 16.379 6.249 22.628.001z"/></svg>
        ...
        <div class="row ">
            <div class="col-12">
                ...
                <br>
                <br>
                <h3 class="ci-color h4">Zusatzleistungen</h3>
                <br>
            </div>
            ...
            <div class="col-12 col-md-4 mb-4">
                <div class="card h-100">
                    <div class="card-body">
                        <h5 class="mb-3">Top Job</h5>

                        <p>Stechen Sie mit Ihrer Stellenanzeigen hervor und positionieren Sie Ihr Jobangebot im Vordergrund</p>



                    </div>
                    <div class="card-footer text-end">
                        <span style="color: #f49c35; font-size: 22px;" class="text-end">249 € </span><span style="color: #f49c35;" class="small"> <span class="text-dark">/ 30 Tage</span></span>
            ...
            <div class="col-12 col-md-4 mb-4">
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        <h5 class="mb-3">Stellenservice</h5>

                        <p>
                            Wir kümmern uns um Ihre Stellenanzeigen und übernehmen auf Wunsch gerne das Texten Ihrer Anzeigen.
                        </p>

                    </div>
                    <div class="card-footer text-end">
                        <span style="color: #f49c35; font-size: 22px;" class="text-end">ab 60 € </span><span style="color: #f49c35;" class="small"> <span class="text-dark">/ Arbeitsstunde</span></span>
            ...
            <div class="col-12 col-md-4 mb-4">
                <div class="card h-100">
                    <div class="card-body">
                        <h5 class="mb-3">Job Schnittstelle</h5>

                        <p>
                            Ihre Stellen können automatisch über eine XML oder eine .json Schnittstelle in unser Portal importiert werden. Die Einrichtung erfolgt für Sie kostenlos.

                        </p>

                    </div>
                    <div class="card-footer text-end">
                        <span style="color: #f49c35; font-size: 22px;" class="text-end">kostenlos </span>
            ...
            <div class="col-12 col-md-4 mb-4">
                <div class="card h-100">
                    <div class="card-body">
                        <h5 class="mb-3">Social Media Beiträge</h5>

                        <p>
                            Mit einem gesponserten Beitrag können Sie die Reichweite Ihres Unternehmens oder einer Stellenanzeige gezielt boostern.
                        </p>

                    </div>
                    <div class="card-footer text-end">
                        <span style="color: #f49c35; font-size: 22px;" class="text-end">ab 99 €</span><span style="color: #f49c35;" class="small text-dark">  einmalig</span>
            ...
            <div class="col-12 col-md-4 mb-4">
                <div class="card h-100">
                    <div class="card-body">
                        <h5 class="mb-3">Stellenportal</h5>

                        <p>
                            Mit Ihrem eigenen Stellenportal veröffentlichen Sie Ihre Stellen in ihrem eigenen Design.

                        </p>
                    </div>
                    <div class="card-footer text-end">
                        <span style="color: #f49c35; font-size: 22px;" class="text-end">ab 1800 € </span><span style="color: #f49c35;" class="small"> <span class="text-dark"></span></span>
            ...
            <div class="col-12">
                ...
                <br>
                <i class="text-end mt-5 " style="float: right;">Alle Preise richten sich ausschließlich an Gewerbekunden und verstehen sich zzgl. gesetzlicher Mehrwertsteuer.</i>
                <br>
                <br>
                <br>
                <br>
