  ...
  <header class="">
    ...
    <main>
        <section class="container">
            <div class="principal">
                <img class="img-fluid" src="https://www.jobs-oberpfalz.de/uploads/cover/763.jpg" alt="">
                <div class="txt">
            ...
            <div class="sobreempresa">
                <h2>Sobre  a empresa Volksbank Raiffeisenbank Nordoberpfalz</h2>
                <p>
                    Nos mostre o que você pode fazer! Fortaleça a equipe do Volksbank Raiffeisenbank Nordoberpfalz eG e inscreva-se online agora. Seja você um trainee, um estagiário ou um funcionário de consultoria qualificada ou um de nossos departamentos especializados - aguardamos seu talento!
                </p>
                <button><a href="https://www.vr-nordoberpfalz.de" id="btn-empresa">Visite nosso site</a></button>

            </div>
            <div class="txt-vagas">
                <h2>Ofertas de trabalho atuais</h2>
            </div>
            <div class="col-left">
